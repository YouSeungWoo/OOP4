...
class Game():
    def __init__(self):
        ...
        self.geo = Geo(50, 50) # 50 50 크기의 Geo 생성
        # 유전정보 생성하기
...
#                        self.screen.blit(BackgroundImage.stage1, 0, 0)
            intro_image, intro_image_rect=load_image('Intro_image.png')
            self.screen.blit(intro_image, (0,0))
            start_image=sysfont.render("Press any key to Start...", True, (255,255,255))   
